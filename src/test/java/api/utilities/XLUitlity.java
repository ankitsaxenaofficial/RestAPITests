...
public class XLUitlity {
	...
	public void fillGreenColor(String sheetName, int colNum, int rowNum) throws Exception {
...
public void fillRedColor(String sheetName, int colNum, int rowNum) throws Exception {
